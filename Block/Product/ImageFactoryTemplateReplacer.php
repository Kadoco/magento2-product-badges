...
namespace Kadoco\Badge\Block\Product;
...
class ImageFactoryTemplateReplacer extends ProductImageFactory
{
    /**
     * @var ConfigInterface
     */
    ...
    public function create(Product $product, string $imageId, array $attributes = null): ImageBlock
    {
        ...
        $data = [
            'data' => [
                'template' => 'Kadoco_Badge::product/image_with_borders.phtml',
